...
<aside
    ...
    <div class="flex-shrink-0 p-4 border-t border-indigo-300 bg-indigo-100">
        ...
        <main class="md:ml-64 transition-all duration-300">
            <!-- Top Navigation -->
            <header class="bg-white shadow-sm sticky top-0" style="z-index: 500">
                    ...
                    <table class="min-w-full bg-white border-collapse">
                        <thead class="bg-indigo-50">
                            <tr>
                                ...
                                <th colspan="2" class="px-6 py-4 text-left text-sm font-semibold text-indigo-700">Actions
                                </th>
                            </tr>
                        </thead>
            ...
            @foreach ($users as $user)
                <div id="modal-{{ $user->id }}"
                    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 backdrop-animation" style="z-index: 1000">
                    <div
                        class="modal-animation bg-white rounded-xl shadow-2xl w-full max-w-2xl p-6 mx-4 
