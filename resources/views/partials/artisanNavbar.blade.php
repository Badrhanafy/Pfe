        ...
        <div class="container navbar-container">
            ...
            <div class="brand-container">
                <a href="{{ route('welcome') }}">
                    <img src="http://127.0.0.1:8000/images/logo.svg" class="brand-icon" alt="Artisan Network Logo">
                </a>
            </div>
            ...
            <div class="nav-main">
                ...
                <div class="nav-links">
                    ...
                    <a class="nav-link" href="{{ route('Messagebox',Auth::artisan()->id) }}">
                      <i class="fas fa-home"></i> messagebox
                    </a>
            ...
            <div class="nav-right">
                ...
                <div class="profile-dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <hr>
                        <form action="{{ route('logout') }}" method="post" class="pb2" >
                            @csrf
                            <center>
